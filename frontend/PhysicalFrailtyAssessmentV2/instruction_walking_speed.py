...
class InstructionWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Walking Speed Test Instructions")
        self.setFixedSize(600, 400)
        self.setStyleSheet("background-color: #FFF8F0;")

        lbl = QLabel("Walking Speed Test Instructions")
        ...
        text = QLabel(
            ...
            "3. Walk naturally to the finish line\n"
            "4. Press Stop when you cross the line\n"
        )
