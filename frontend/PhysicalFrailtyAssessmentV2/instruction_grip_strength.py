...
class InstructionWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Grip Strength Test Instructions")
        self.setFixedSize(600, 400)
        self.setStyleSheet("background-color: #FFF8F0;")

        lbl = QLabel("Grip Strength Test Instructions")
        lbl.setFont(QFont("Yu Gothic UI", 20))
        lbl.setAlignment(Qt.AlignCenter)
        lbl.setStyleSheet("color: #5B2C6F;")

        text = QLabel(
            "1. Hold the handgrip device firmly\n"
            "2. Squeeze as hard as you can\n"
            "3. Release when test completes\n"
        )
